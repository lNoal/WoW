...
function mordredClicked(self)
	...
	if MORDRED_STATE == "USE" then
		if mx > 0 and my < 289 and my > 197 and mx < 55 and not LANTERN_CLICKED and MORDRED_STATE == "USE" then
			...
			mordred_timer = 0
			mordred_stage = 1
		elseif mx > 600 and my < 270 and mx < 770 and my > 203 and not FIRE_CLICKED and MORDRED_STATE == "USE" then
			MORDRED_STATE = "FIRE"
			FIRE_CLICKED = true
			mordred_timer = 0
			mordred_stage = 1
		elseif mx > 1111 and my < 120 and mx < 1298 and my > 0 and not MUSICBOX_CLICKED and FIRE_CLICKED and LANTERN_CLICKED and MORDRED_STATE == "USE" then
